...
public class KafkaStreamConsumer {
    ...
    public void start() {
        ...
        streamProcessor.getSubredditMensionsStream(initialStream).merge(streamProcessor.calculateStreamCount(initialStream)).to("reddit-json", Produced.with(Serdes.String(), Serdes.String()));
