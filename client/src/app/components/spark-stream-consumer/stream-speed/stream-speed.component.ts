...
@Component({
  selector: 'app-stream-speed',
  templateUrl: './stream-speed.component.html',
  styleUrls: ['./stream-speed.component.css']
})
export class StreamSpeedComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  browserOnly(f: (speedComponent: StreamSpeedComponent) => void) {
...
// using chart.setTimeout method as the timeout will be disposed together with a chart
  ...
  ngOnInit(): void {
    this.randomIdValueString = `` + StreamSpeedComponent.counterId;
    StreamSpeedComponent.counterId++;
