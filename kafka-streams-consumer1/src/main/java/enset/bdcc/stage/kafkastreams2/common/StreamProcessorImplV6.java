...
public class StreamProcessorImplV6 implements StreamProcessor {
    ...
    public KStream<String, String> getSubredditMensionsStream(KStream<String, Submission> initialStream) {
        return  initialStream
                .map((KeyValueMapper<String, Submission, KeyValue<String, Long>>) (k, v) -> new KeyValue<>(v.getSubreddit(), 1L)
                )
                .groupByKey(Grouped.with(Serdes.String(), Serdes.Long()))
                .windowedBy(TimeWindows.of(TimeUnit.SECONDS.toMillis(6)).advanceBy(TimeUnit.SECONDS.toMillis(6)))
                .reduce(Long::sum)
                .toStream()
                .map((key, value) -> {
                            if(value == 1) return new KeyValue<>("__Others__", 1L);
                ...
                .toStream()
                    ...
                    public KeyValue<String, String> apply(String key, Long value) {
                        ...
                        return new KeyValue<>("group", objectMapper.writeValueAsString(subredditData));
                    }
...
//                            System.out.println("VALUES STRING ----->" + valuesString);
                ...
                .map(new KeyValueMapper<String, String, KeyValue<String, String>>() {
                    ...
                    public KeyValue<String, String> apply(String key, String value) {
                        ...
                        return new KeyValue<>("Result_Batch", jsonString);
                    }
                });
